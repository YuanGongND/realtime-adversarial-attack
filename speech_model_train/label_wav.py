...
def run_graph(wav_data, labels, input_layer_name, output_layer_name,
  ...
  with tf.Session() as sess:
    ...
    decode_wav = sess.graph.get_tensor_by_name('decoded_sample_data:0')
    predictions, decode_wav_show = sess.run([softmax_tensor, decode_wav], {input_layer_name: wav_data})
    np.savetxt('decode_wav.csv', decode_wav_show, delimiter=',')
